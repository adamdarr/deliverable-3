 ...
 * Story 1, Scenario 3
 * 
 * Given an invalid email address and password 
 * when logging in 
 * then I should see a message telling me I entered the wrong information
 */
public class TestInvalidEmailAndPassword {
  ...
  @Test
  public void testInvalidEmailAndPassword() throws Exception {
    driver.get(baseUrl + "/");
    ...
    driver.findElement(By.cssSelector("form[name=\"signInVm.signInForm\"] > div.s-row.s-form-group > div.s-col-sm-12 > input[name=\"email\"]")).sendKeys("abcdef");
    ...
    assertEquals("Valid email is required", driver.findElement(By.cssSelector("div.s-help-block.ng-active > div > p")).getText());
  }
