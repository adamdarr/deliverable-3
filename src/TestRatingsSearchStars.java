 ...
 * then I should be able to see the ratings (out of five stars) for each of the results 
 */
public class TestRatingsSearchStars {
  ...
  @Test
  public void testRatingsSearchStars() throws Exception {
    driver.get(baseUrl + "/");
