...
public class TestSearchChinese {
  ...
  public void testSearchChinese() throws Exception {
    ...
    driver.findElement(By.xpath("(//input[@type='search'])[4]")).sendKeys("chinese");
    ...
    assertEquals("Chinese", driver.findElement(By.cssSelector(".search-results-hero-searchTerm")).getText());
  }
