 ...
 * Story 3, Scenario 2
 * 
 * Given I type in a search for “hamburgers” 
 * when I press the search button 
 * then I’m given a results page with hamburger restaurants
 */
public class TestSearchHamburgers {
  ...
  @Test
  public void testSearchHamburgers() throws Exception {
    driver.get(baseUrl + "/");
    ...
    driver.findElement(By.xpath("(//input[@type='search'])[4]")).sendKeys("hamburgers");
    ...
    assertEquals("Hamburgers", driver.findElement(By.cssSelector(".search-results-hero-searchTerm")).getText());
  }
