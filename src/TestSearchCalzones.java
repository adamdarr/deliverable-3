 ...
 * Story 3, Scenario 5
 * 
 * Given I type in a search for “calzones” 
 * when I press the search button 
 * then I’m given a results page with calzone restaurants
 */
public class TestSearchCalzones {
  ...
  @Test
  public void testSearchCalzones() throws Exception {
    driver.get(baseUrl + "/");
    ...
    driver.findElement(By.xpath("(//input[@type='search'])[4]")).sendKeys("calzones");
    ...
    assertEquals("Calzones", driver.findElement(By.cssSelector(".search-results-hero-searchTerm")).getText());
  }
